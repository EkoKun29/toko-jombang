@extends('layouts.app')
@section('title')
    Ambil Uang di Bank ke Aliansyah
@stop
@section('content')
    <div class="card-body">
        ...
        @include('ambil-uang-di-bank.aliansyah.create')
        <x-alert />
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                @include('ambil-uang-di-bank.aliansyah.edit')
                                @include('ambil-uang-di-bank.aliansyah.delete')
                            </div>
                        </td>
                    </tr>
                @empty
